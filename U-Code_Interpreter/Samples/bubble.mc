...
inc    =  9         dec    =  2         add    =  27        sub    =  1         
gt     =  6         lt     =  5         le     =  5         ne     =  4         
lod    =  65        ldc    =  19        lda    =  24        ldi    =  13        
ldp    =  8         str    =  19        sti    =  7         ujp    =  11        
fjp    =  20        call   =  8         ret    =  1         nop    =  26        
proc   =  1         end    =  1         bgn    =  1         sym    =  6         


 Executable instruction count  =   255

 Total execution cycle         =   2216
